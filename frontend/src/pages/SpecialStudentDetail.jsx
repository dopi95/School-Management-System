  ...
  if (!student) {
    return (
      <div className="text-center py-12">
        <p className="text-gray-500 dark:text-gray-400">Special student not found</p>
        <Link to="/special-students" className="btn-primary mt-4">Back to Special Students</Link>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Special Student Details</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-2">View and manage special student information</p>
        </div>
      </div>
...
export default SpecialStudentDetail;